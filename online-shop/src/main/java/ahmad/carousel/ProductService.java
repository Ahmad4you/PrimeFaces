...
public class ProductService {
    ...
    public void init() {
        ...
        products.add(new Product(1000, "f230fh0g3", "Bamboo Watch", "Product Description", "logo.jpg", 65,
                "Accessories", 24, InventoryStatus.INSTOCK, 5));
        products.add(new Product(1001, "nvklal433", "Black Watch", "Product Description", "hasen.png", 72,
                "Accessories", 61, InventoryStatus.INSTOCK, 4));
        products.add(new Product(1002, "zz21cz3c1", "Blue Band", "Product Description", "handtasche.jpg", 79,
                "Fitness", 2, InventoryStatus.LOWSTOCK, 3));
        products.add(new Product(1003, "244wgerg2", "Blue T-Shirt", "Product Description", "filzschuhe.jpg", 29,
