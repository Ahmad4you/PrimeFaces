...
a persistence unit "scooping-EARPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "scooping-EAR/pom.xml":
...
artifacts ("scooping-EAR-ejb.jar" and "scooping-EAR-web.war") are already built. You can build
